...
uvj_cdfs = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'uvj_cdfs.csv'))
uvj_cosmos = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'uvj_cosmos.csv'))
uvj_uds = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'uvj_uds.csv'))
...
datasets, fields = [uvj_cdfs, uvj_cosmos, uvj_uds], ['cdfs', 'cos', 'uds']
