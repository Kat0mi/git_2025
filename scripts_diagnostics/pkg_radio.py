...
radio_cdfs = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'radio_cdfs.csv'))
radio_cosmos = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'radio_cosmos.csv'))
radio_uds = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'radio_uds.csv'))
...
datasets, fields = [radio_cdfs, radio_cosmos, radio_uds], ['cdfs', 'cos', 'uds']
