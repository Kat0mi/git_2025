...
xray_cdfs = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'xray_cdfs.csv'))
xray_cosmos = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'xray_cosmos.csv'))
xray_uds = pd.read_csv(os.path.join('/', 'Users', 'jess', 'Desktop', 'git_2025_overflow', 'datasets', 'xray_uds.csv'))
...
datasets, fields = [xray_cdfs, xray_cosmos, xray_uds], ['cdfs', 'cos', 'uds']
